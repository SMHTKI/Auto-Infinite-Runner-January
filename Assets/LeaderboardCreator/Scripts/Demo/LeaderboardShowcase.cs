...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void SetPlayerScore(int Score)
        {
            ...
            int n = (int)Mathf.Floor(Mathf.Log10(_playerScore) + 1);
        ...
        public void Load()
        {
            ...
            Leaderboards.SealGameLeaderboard.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            Leaderboards.SealGameLeaderboard.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }
        
        public void DeleteEntry()
        {
            Leaderboards.SealGameLeaderboard.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.SealGameLeaderboard.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
        ...
        public void DisplayPersonalBestScore()
        {
